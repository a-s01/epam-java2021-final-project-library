        ...
        <div class="container-sm col-sm-10 col-sm-offset-1">
            ...
            <form action="/controller" method="post">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-md-7">
                        <input name="passwordReg" type="password" id="password" class="col-md-6 form-control"><br/>
                    </div>
                </div>
                <div class="row mb-2">
                    <label for="anotherPass" class="col-md-3 col-form-label">Retype password: </label>
                    <div class="col-md-7">
                        <input name="anotherPass" type="password" id="anotherPass" class="col-md-6 form-control"><br/>
                    </div>
                </div>
                <div class="row mb-2">
                    <label for="name" class="col-md-3 col-form-label">Name: </label>
                    <div class="col-md-7">
                        <input name="name" type="text" id="name" class="form-control" value="<c:out value='${proceedUser.name}' />"><br />
                    </div>
                </div>
                <div class="row mb-2">
